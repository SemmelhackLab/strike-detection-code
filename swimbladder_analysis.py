...
if __name__ == "__main__":
    ...
    folder = 'F:\Data\\190503_CYT_whiteVisual_deg\Distance test F1\\10mm'  #this should be the folder where you put all the videos for analysis # folder = pickdir() # alternative way to do
    ...
    bladder_thresh = None # setted like 200 or None
    ...
    for avi in avis:
        ...
        if bladder_thresh == None:
            while (1):
                ...
                video = Video(os.path.join(folder, avi))
                bladder_thresh = setThreshold(video, 212, ROI)  # tag
